...
_G.packer_plugins = {
  ...
  ["bufferline.nvim"] = {
    loaded = true,
    path = "/Users/umschaudhary/.local/share/nvim/site/pack/packer/start/bufferline.nvim",
  ...
  ["lsp-format.nvim"] = {
    loaded = true,
    path = "/Users/umschaudhary/.local/share/nvim/site/pack/packer/start/lsp-format.nvim",
